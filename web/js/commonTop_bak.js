...
function homeHeader(){
	...
	sideBannerHTML += '		</li>';
	sideBannerHTML += '		<li id="minkabu">';
	sideBannerHTML += '			<a href="http://cfes.jp/" target="_blank"><img src="images/banner_comofes.png" alt="コモディティフェスティバル2014"></a>';
	sideBannerHTML += '		</li>';
        sideBannerHTML += '		<br>';
	...
	sideBannerHTML += '		<li id="">';
	sideBannerHTML += '			<a href="http://www.komenet.jp/index.html" target="_blank"><img src="http://www.komenet.jp/about/image/0000000826001.gif" width="150" height="50" border="0" alt="「米ネット」"></a>';
	sideBannerHTML += '		</li>';
